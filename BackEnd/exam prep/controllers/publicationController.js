...
router.get('/:publicationId/details', async (req, res) => {
    ...
    res.render('publications/details', { publication, isAuthor, isShared })
});
...
router.post('/:publicationId/edit', isAuth, preloadPublication, isPublicationAuthor, async (req, res) => {
    ...
    try {
        ...
        res.render(`publications/edit`, { ...req.body, error: getErrorMessage(error) })
    }
...
router.post('/create', isAuth, async (req, res) => {
    ...
    try {
        ...
        res.render('publications/create', { ...req.body, error: getErrorMessage(error) })
    }
