      ...
      <header className="App-header">
        <form onSubmit={submitHandler}>
          <div>
            ...
            <input value={values.username} id='username' type="text" name='username' onChange={changeHandler} />
          </div>

          <div>
            <label htmlFor="password">Password: </label>
            <input id='password' type="password" value={values.password} name='password' onChange={changeHandler} />
          </div>
          ...
          <div>
            ...
            <input type="text" name='uncontrolled' id='uncontrolled-input' />
          </div>
