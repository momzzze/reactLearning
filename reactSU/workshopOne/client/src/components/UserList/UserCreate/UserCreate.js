...
export const UserCreate = ({
    ...
    const isPositive = (e) => {
        ...
        setErrors(state => ({ ...state, [e.target.name]: number < 0 }))
    }
                    ...
                    <form onSubmit={submitHandler}>
                        ...
                        <div className="form-row">
                            ...
                            <div className="form-group">
                                ...
                                {errors.phoneNumber &&
                                    <p p className="form-error">Phone number is not valid!</p>
                                }
                            </div>
                        </div>
                        ...
                        <div className="form-row">
                            <div className="form-group">
                                ...
                                <div className="input-wrapper">
                                    <span><i className="fa-solid fa-map"></i></span>
                                    <input id="street" name="street" type="text" value={values.street} onChange={changeHandler} onBlur={(e) => minLength(e, 5)} />
                                </div>
                                {errors.street &&
                                    <p className="form-error">
